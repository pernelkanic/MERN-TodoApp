...
export const getWorkout =async(req:MyUserRequest,res:Response)=>{
...
export const singlegetWorkout =async(req : Request,res: Response)=>{
    const { id  }  = req.params;
...
export const createWork =async(req : MyUserRequest,res : Response)=>{
